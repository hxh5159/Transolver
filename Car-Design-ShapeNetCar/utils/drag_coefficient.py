...
def cal_coefficient(file_name, press_surf=None, velo_surf=None,
    ...
    sample_path = file_name if os.path.dirname(file_name) else os.path.join('param0', file_name)
    file_name_press = os.path.join(sample_path, 'quadpress_smpl.vtk')
    file_name_velo = os.path.join(sample_path, 'hexvelo_smpl.vtk')
